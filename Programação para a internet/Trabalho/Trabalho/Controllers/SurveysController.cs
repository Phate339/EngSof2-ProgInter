...
namespace Trabalho.Controllers
{
    public class SurveysController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("SurveyID,SurveyState")] Survey survey)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("SurveyID,SurveyState")] Survey survey)
        {
