...
namespace Trabalho.Controllers
{
    public class AnswersController : Controller
    {
        ...
        {
            ViewData["DifficultyID"] = new SelectList(_context.Difficulty, "DifficultyID", "DifficultyName");
            ViewData["QuestionsID"] = new SelectList(_context.Questions, "QuestionsID", "QuestionsToClient");
            return View();
        }
